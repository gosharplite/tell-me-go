...
8. **Butler outputs a summary** for each iteration, commits the changes to the new branch, and after all issues are addressed and signed off, outputs a final summary and exits the agent loop.
