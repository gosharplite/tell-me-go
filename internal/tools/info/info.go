...
func (m *Manager) GetProjectSummary(ctx context.Context, args map[string]interface{}) (types.ToolResult, error) {
...
func (m *Manager) GoDoc(ctx context.Context, args map[string]interface{}) (types.ToolResult, error) {
	var params struct {
