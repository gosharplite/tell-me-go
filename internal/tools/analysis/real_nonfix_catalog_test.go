...
func TestVerifyNonFixCatalog(t *testing.T) {
	...
	expectedCataloged := map[string]funcComplexity{
		...
		"TestRunCommand_NonExitErrorWaitPath":                       {Line: 818, Complexity: 11, FilePath: "internal/tools/workspace/process_executor_stream_test.go"},
		"TestRunCommandFaultPaths":                                  {Line: 29, Complexity: 26, FilePath: "internal/tools/workspace/process_executor_fault_test.go"},
		"TestRunPipelineFaultCleanup":                               {Line: 280, Complexity: 16, FilePath: "internal/tools/workspace/process_executor_fault_test.go"},
		"TestPipelineWaitFaultSemantics":                            {Line: 23, Complexity: 15, FilePath: "internal/tools/workspace/pipeline_fault_test.go"},
		"TestShellFaultPipeCommands":                                {Line: 108, Complexity: 14, FilePath: "internal/tools/workspace/shell_fault_test.go"},
		"TestShellFaultExecuteCommand":                              {Line: 35, Complexity: 12, FilePath: "internal/tools/workspace/shell_fault_test.go"},
		...
		"TestFakeProcessRunner_PresetFunc":                          {Line: 52, Complexity: 12, FilePath: "internal/tools/toolstest/fake_process_runner_test.go"},
		...
		"TestStdio_LauncherTreePassThrough":                         {Line: 262, Complexity: 13, FilePath: "internal/infrastructure/mcp/stdio_client_integration_test.go"},
		"TestStdio_ChildDeathMidSession":                            {Line: 324, Complexity: 13, FilePath: "internal/infrastructure/mcp/stdio_client_integration_test.go"},
		"TestResolveCommand":                                        {Line: 25, Complexity: 13, FilePath: "internal/infrastructure/mcp/stdio_client_test.go"},
		"metadataIDs":                                               {Line: 177, Complexity: 11, FilePath: "internal/agent/memory/injector.go"},
		"TestHookBatch":                                             {Line: 247, Complexity: 22, FilePath: "internal/agent/memory/hook_test.go"},
...
func TestVerifyCoveragePinsMatchLiveCatalog(t *testing.T) {
	...
	tests := []struct {
		...
		{"runner.go StderrPipe error", "internal/infrastructure/process/runner.go", 72, 75},
		{"proc_posix.go Cancel nil-Process guard", "internal/infrastructure/process/proc_posix.go", 47, 49},
		{"proc_posix.go non-ESRCH killGroup branch", "internal/infrastructure/process/proc_posix.go", 59, 61},
		{"proc_posix.go checkAlive ErrProcessDone branch", "internal/infrastructure/process/proc_posix.go", 64, 66},
		...
		{"flock_unix.go acquireWriteLock non-EWOULDBLOCK error branch", "internal/agent/memory/flock_unix.go", 52, 53},
		...
		{"process_executor.go resolveAndValidateOutputPath windows branch", "internal/tools/workspace/process_executor.go", 331, 341},
		{"analysistest MockSymbolIndex HarvestDeclarations stub", "internal/tools/analysis/analysistest/mock_index.go", 61, 63},
		{"process_executor.go LookPath delegation", "internal/tools/workspace/process_executor.go", 458, 461},
