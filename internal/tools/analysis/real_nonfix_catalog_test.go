...
func TestVerifyNonFixCatalog(t *testing.T) {
	...
	expectedCataloged := map[string]funcComplexity{
		...
		"(*plurHook).AfterTurn":                                     {Line: 97, Complexity: 21, FilePath: "internal/agent/memory/hook.go"},
		"(*plurHook).FlushSession":                                  {Line: 296, Complexity: 13, FilePath: "internal/agent/memory/hook.go"},
		"(*plurHook).maybeLearn":                                    {Line: 236, Complexity: 11, FilePath: "internal/agent/memory/hook.go"},
		"(*plurInjector).Transform":                                 {Line: 64, Complexity: 18, FilePath: "internal/agent/memory/injector.go"},
		"metadataIDs":                                               {Line: 237, Complexity: 11, FilePath: "internal/agent/memory/injector.go"},
		"TestHookBatch":                                             {Line: 245, Complexity: 20, FilePath: "internal/agent/memory/hook_test.go"},
		"TestHookCaptureBranchI":                                    {Line: 59, Complexity: 13, FilePath: "internal/agent/memory/hook_test.go"},
		"TestHookFull":                                              {Line: 354, Complexity: 21, FilePath: "internal/agent/memory/hook_test.go"},
		...
		"(*server).dispatchTool":                                    {Line: 381, Complexity: 13, FilePath: "tests/e2e/testdata/fakeplur/main.go"},
		"newServer":                                                 {Line: 142, Complexity: 13, FilePath: "tests/e2e/testdata/fakeplur/main.go"},
