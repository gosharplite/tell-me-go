...
var loadToolkitDef = &tools.ToolDeclaration{
	Name:        "load_toolkit",
	Description: "CRITICAL: Use this to load specialized tools into your context. Available toolkits: ['git', 'k8s', 'ado', 'jira', 'confluence', 'media', 'network', 'teams', 'skillssh']. If a user asks to deploy to Kubernetes, you must call load_toolkit(names=['k8s']) first.",
