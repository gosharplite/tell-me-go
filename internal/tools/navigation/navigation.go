...
func (m *Manager) FindUsages(ctx context.Context, args map[string]interface{}) (types.ToolResult, error) {
	var params struct {
...
func (m *Manager) FindDefinitions(ctx context.Context, args map[string]interface{}) (types.ToolResult, error) {
	var params struct {
		Query string `json:"query"`
		Path  string `json:"path"`
	}
...
func (m *Manager) ListSymbols(ctx context.Context, args map[string]interface{}) (types.ToolResult, error) {
	var params struct {
		Path         string `json:"path"`
...
func (m *Manager) ListImplementations(ctx context.Context, args map[string]interface{}) (types.ToolResult, error) {
	var params struct {
		Path string `json:"path"`
	}
	if err := types.UnmarshalArgs(args, &params); err != nil {
			...
			if fd, ok := decl.(*ast.FuncDecl); ok && fd.Recv != nil {
				...
				if info, ok := structs[recvType]; ok {
					info.methods = append(info.methods, methodSig{
						name: fd.Name.Name,
						sig:  astutil.GetFuncTypeSig(fd.Type),
					})
...
func (m *Manager) GetTypeInfo(ctx context.Context, args map[string]interface{}) (types.ToolResult, error) {
	var params struct {
...
func (m *Manager) GrepDefinitionsGo(ctx context.Context, path, query string) ([]string, error) {
	var results []string
