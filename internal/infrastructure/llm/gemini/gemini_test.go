...
func TestClassifyError(t *testing.T) {
	...
	tests := []struct {
		...
		{"sdk_format_504", fmt.Errorf("Error 504, Message: Gateway timeout"), llm.ErrTransient},
...
func TestSendChat_ClassifyError_Integration(t *testing.T) {
	tests := []struct {
		...
		{"HTTP 504 → ErrTransient", http.StatusGatewayTimeout, `{"error":{"code":504,"message":"Gateway timeout"}}`, llm.ErrTransient},
