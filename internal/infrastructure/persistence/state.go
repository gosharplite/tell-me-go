...
func (s *sessionState) GetConfig() ports.ConfigReader          { return s.Config }
...
func initServices(ctx context.Context, taskStore ports.ListStore[ports.Task], configStore, scratchStore ports.KVStore) (ports.TaskStore, ports.ConfigReader, ports.ScratchpadService, error) {
